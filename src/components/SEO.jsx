...
const SEO = ({
  ...
  keywords = "food, reels, restaurant, zomato, delivery, food videos",
  image = "https://yourwebsite.com/default-banner.jpg", // Aapki website ka default logo ya banner
}) => {
  return (
    <Helmet>
      {/* Standard Meta Tags */}
      <title>{title ? `${title} | Zomato Reels` : "Zomato Reels"}</title>
      ...
      <meta
        property="og:title"
        content={title ? `${title} | Zomato Reels` : "Zomato Reels"}
      />
